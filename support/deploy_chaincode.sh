...
OUTPUT="$(curl -XPOST -d  '{"jsonrpc": "2.0", "method": "deploy",  "params": {"type": 1,"chaincodeID": {"path": "github.com/Altoros/catbond/chaincode","language": "GOLANG"}, "ctorMsg": { "args": ["init"] },"secureContext": "system", "attributes": ["role", "name"]},"id": 0}' http://localhost:7050/chaincode)"
